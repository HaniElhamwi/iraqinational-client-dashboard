        ...
        <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
          <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
            <Link href="/" className="main-logo flex shrink-0 items-center">
              <Image width={32} height={32} className="inline ltr:-ml-1 rtl:-mr-1" src="/assets/images/logo.png" alt="logo" />
            </Link>
            <button
              type="button"
          ...
          <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
            ...
            <div className="dropdown shrink-0">
              <Dropdown
                ...
                button={
                  flag && (
                    <img className="h-5 w-5 rounded-full object-cover" src={`/assets/images/flags/${flag.toUpperCase()}.svg`} alt="flag" />
                  )
                }
              >
              ...
              <Dropdown
                ...
                button={
                  <img
                    ...
                    src={user?.image || '/assets/images/user-profile.jpeg'}
                    alt="userProfile"
                  />
                }
              >
                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                  ...
                  <li className="border-t border-white-light dark:border-white-light/10">
                    <div
                      className="!py-3 text-danger flex flex-row px-2 cursor-pointer"
                      onClick={() => {
                        logout();
                      }}
                    >
        ...
        <ul className="horizontal-menu hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-black dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
          ...
          <li className="menu nav-item relative">
            ...
            <ul className="sub-menu">
              ...
              <li>
                <Link href="https://akram.agency" target="_blank">
                  {t('documentation')}
                </Link>
              </li>
            </ul>
