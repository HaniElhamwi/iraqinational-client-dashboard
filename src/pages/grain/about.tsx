...
const Transportation = () => {
  ...
  const { data, isError, isLoading } = useQueryGlobal({ collection: 'grain', document: 'about' });
  const { error, isLoading: updateLoading, mutateAsync } = useMutateGlobal({ collection: 'grain', field: 'about' });
