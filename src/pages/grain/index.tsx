...
const Transportation = () => {
  ...
  const { data, isError, isLoading } = useQueryGlobal({ collection: 'grain', document: 'main' });
  const { error, isLoading: updateLoading, mutateAsync } = useMutateGlobal({ collection: 'grain', field: 'main' });
