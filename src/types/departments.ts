import { object, optional, type Output, any } from 'valibot';
...
export const DepartmentsFormSchema = object({
  images: optional(any()),
...
export type DepartmentsFormData = Output<typeof DepartmentsFormSchema>;
