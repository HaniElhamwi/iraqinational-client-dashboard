...
export const DrinkAboutFormSchema = object({
  arTitle: string(undefined, [minLength(3, 'departments.title_required')]),
  enTitle: string(undefined, [minLength(3, 'departments.title_required')]),
  arDescription: string(undefined, [minLength(3, 'departments.description_required')]),
  enDescription: string(undefined, [minLength(3, 'departments.description_required')]),
  enSubTitle: string(undefined, [minLength(3, 'departments.sub_title_required')]),
  arSubTitle: string(undefined, [minLength(3, 'departments.sub_title_required')]),
...
export type DrinkAboutFormData = Output<typeof DrinkAboutFormSchema>;
